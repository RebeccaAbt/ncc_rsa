...
from utils.fusion import fuse_timepoint_pd, fuse_timepoint_pd_parallel
...
class Fusion_pd(Job):
    def run(self,
        ...
        for t in tqdm(rdm_movie, desc=f'Fusing MEG/fMRI data for {len(rdm_movie)} time points...'):
            fusion_data.append(fuse_timepoint_pd_parallel(t, SL_rdms, sensory_vec, suprasensory_vec))
