...
# for thisConfig in ['MRIconfig_C2', 'MRIconfig_C5']:
    ...
    #                        cpus=12,
    #                        time=1*60, # 1h is enough for SL_rasius=2, but for SL-_radius=5, we need more time! --> 2.5 - 3 h
    #                        qos='high_prio',
    #                        name = f'MRI_{thisConfig.split('_')[1]}.sh',
    # 					   jobs_dir = f'rsa_mri'
    #                        )
...
thisConfig = 'MRIconfig_C5'
subjectID = '20000118sbnb'
partialMasks = [29, 33, 34]
...
thisConfig = 'MRIconfig_C5'
subjectID = '20010917rswg'
partialMasks = [27, 28, 29, 33]
